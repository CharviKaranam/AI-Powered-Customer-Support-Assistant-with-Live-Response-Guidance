...
- EMPATHY FIRST: Validate customer emotions sincerely before presenting technical facts or constraints.
- CONTEXT SPECIFICITY: Integrate exact conversation specifics (order IDs, product names, dates, amounts).
- ACTION-ORIENTED: Keep suggested responses concise (2-4 sentences), ready for the agent to send.
- TACTICAL NEXT BEST ACTION: Provide a single high-impact directive for the agent.
- GUARDRAILS / DO-NOTS: 2-3 specific bad practices or negative phrases to avoid.
