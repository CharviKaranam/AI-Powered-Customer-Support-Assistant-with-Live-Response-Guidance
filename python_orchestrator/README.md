# Python LangGraph Multi-Agent Support Orchestrator

This module provides the complete, production-grade **Python LangGraph** multi-agent orchestration layer for the Real-Time AI Support Assistant & Coaching platform.
...
├── run_demo.py              # Standalone Python CLI testing runner
└── nodes/
    ├── __init__.py
...
```bash
python -m python_orchestrator.run_demo
```

### 4. Start FastAPI LangGraph Server
```bash
uvicorn python_orchestrator.server:app --host 0.0.0.0 --port 8000 --reload
```
